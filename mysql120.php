...
<div id="container">
	...
	<table border="3" bordercolor="white" width="100px" height="400px">
	<h1>사용할 데이터 출력 하기 </h1>
    ...
    생태구역 : <select name="area">
		 ...
		 표층수온 : <input type="text" id="amount" readonly style="border:0; color:#f63f1f; font-weight:bold;" name="slide-value"/>

		 저층수온 : <input type="test" id="amount" readonly style="border:0; color:#1ff635; font-weight:bold;" name=
		 "slide-value"/>
	...
	<?php
	 ...
	 echo "저층수온 최소값 : ".$min_value."<br/>"; //출력값 확인용
	 echo "저층수온 최대값 : ".$max_value."<br/>";
	
	 
	 
 	 if(!empty( $year2 )){
          $sql_template = "SELECT * FROM `datatable` WHERE `년월`= %d AND `표층수온`>%f AND `표층수온`<%f";
          //%d는 정수형,%f는 실수형
