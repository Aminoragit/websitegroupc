...
">
	...
	<form method="POST" action="datatable1.php">
	<div style="width: 80%; padding:10px; margin-left: 30px;margin-left: 10%;" data-aos-duration="1500" class="aos-init aos-animate">
	<table class="blackTable">
	<thead>
		<tr>
		<th align="center" colspan="2">기간</th>
		</tr>	
