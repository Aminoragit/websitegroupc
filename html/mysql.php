...
<link rel="stylesheet" href="./index_files/css/jquery-ui.min.css" />
...
<script type="text/javascript" src="./index_files/js/gdsUtil.js"></script>
<script type="text/javascript" src="./index_files/js/custom.js"></script>
<!-- 해당 script를 실행하면 js에 포함된 jquery랑 버전 충돌이 일어나 menu popup과 slider가 표시되지 않으니 주의할것 -->
...
<style>
	...
	.button_search:hover {background-color: #3e8e41}
...
<div id="mwrap">
	<div class="top_area">
		<dl class="logo_box">
			<dt>
				<h1 class="logo">
					<a href="http://groupc.dothome.co.kr/index.html" class="gov_logo1"><img src="./index_files/image/icon.jpg" alt="C조 홈페이지" width="50" height="50" style="width: 30px; height: 30px;"></a>
				</h1>
			</dt>
		</dl>
	</div>
...
<!-- header 부분-->
<div id="header" class="main-header" style="height: 201px;">
...
<!--메인 메뉴 부분-->	
<div class="mgnb-wrap" style="height: 55px;">
	<div class="mgnb-areas">
		<ul class="mgnbs" style="width: 1000px; padding-left: 0px;">
			...
			<!--메뉴1 예측모델 구상 목표-->
			<li class=""><a href="http://groupc.dothome.co.kr/html/predictmodelgoal.html">예측모델 구상 목표</a></li>

			<!--메뉴2 머신러닝 딥러닝-->
			<li class=""><a href="http://192.168.0.192:5000/knn">머신러닝 딥러닝</a>
				<div class="mgnbs-div">	
					<dl>
						<dt class="sub1_1"><p>머신러닝</p></dt>
						<dd>
							<ul>
								<li class="sub1_1_1"><a href="http://192.168.0.192:5000/knn">Knn</a></li>
								<li class="sub1_1_2"><a href="http://192.168.0.192:5000/kmeans">K-Means</a></li>
								<li class="sub1_1_3"><a href="http://192.168.0.192:5000/tree">DecisionTree</a></li>
								<li class="sub1_1_4"><a href="http://192.168.0.192:5000/r_forest">R_Forest</a></li>
								<li class="sub1_1_5"><a href="http://192.168.0.192:5000/Gradient">Gradient</a></li>
							</ul>									
						</dd>		
					</dl>
					<dl>
						...
						<dd>
							<ul>
								<li class="sub1_1_1"><a href="http://192.168.0.192:5000/keras">Keras(Dense)</a></li>
			...
			<!--메뉴3 데이터셋 사이트-->
			<li class=""><a href="http://groupc.dothome.co.kr/html/DataSetsite.html">데이터셋 사이트</a>
				<div class="mgnbs-div">
					<dl>
			...
			<!--메뉴4 MySQL-->
			<li class=""><a href="http://groupc.dothome.co.kr/html/data_download.html">MySQL</a>
				<div class="mgnbs-div">
					<div class="mgnbs-div2">
						<dl>
							...
							<dd>
								<ul>
									<li class="sub3_2_1"><a href="http://groupc.dothome.co.kr/html/howwork.html">DB 조회 방법</a></li>
						...
						<dd>
							<ul>
								<li class="sub3_1_1"><a href="http://groupc.dothome.co.kr/html/data_download.html">전처리 데이터 다운로드</a></li>
							</ul>									
						</dd>
						</dl>
					</div>
			...
			<!-- 메뉴5 C조소개-->
			<li class=""><a href="http://groupc.dothome.co.kr/index.html">C조에 대하여</a></li></ul>
				...
				<div class="mgnbs-div3" style="display: block;width: 1080px;">
					<div class="section-sitemap">
						...
						<ul class="sitemap-d1 s1">
							...
							<li><a href="http://192.168.0.192:5000/knn">머신러닝/딥러닝</a>
								<!-- <ul .sitemap-d2>==하위 메뉴 -->
								<ul class="sitemap-d2">
									<li class="has-child"><a href="http://192.168.0.192:5000/knn">머신러닝</a>
										<!-- <ul .sitemap-d3>==최하위 메뉴-->
										<ul class="sitemap-d3">
											<li><a href="http://192.168.0.192:5000/knn">KNN</a></li>
											<li><a href="http://192.168.0.192:5000/kmeans">K-Means</a></li>
											<li><a href="http://192.168.0.192:5000/tree">DecisionTree</a></li>
											<li><a href="http://192.168.0.192:5000/r_forest">R_Forest</a></li>
											<li><a href="http://192.168.0.192:5000/Gradient">Gradient</a></li>
										</ul>
									</li>
								</ul>

								<ul class="sitemap-d2">
									<li class="has-child"><a href="http://192.168.0.192:5000/keras">딥러닝</a>
										<ul class="sitemap-d3">
											<li><a href="http://192.168.0.192:5000/keras">Keras(Dense)</a></li>
						...
						<ul class="sitemap-d1 s2">
							<li><a href="http://groupc.dothome.co.kr/html/DataSetsite.html">데이터셋 사이트</a>
								<ul class="sitemap-d2">
									<li class="has-child"><a href="http://groupc.dothome.co.kr/html/DataSetsite.html">공공데이터 포털 추천</a>
										<ul class="sitemap-d3">
								...
								<ul class="sitemap-d2">
									<li class="has-child"><a href="http://groupc.dothome.co.kr/html/DataSetsite.html">기상자료 데이터 포털</a>
										<ul class="sitemap-d3">
								...
								<ul class="sitemap-d2">
									<li class="has-child"><a href="http://groupc.dothome.co.kr/html/DataSetsite.html">공모전/데이터</a>
										<ul class="sitemap-d3">
						...
						<ul class="sitemap-d1 s3">
							<li><a href="http://groupc.dothome.co.kr/mysql.php">MYSQL</a>
								<ul class="sitemap-d2">
									<li class="has-child"><a href="http://groupc.dothome.co.kr/html/data_download.html">전처리 데이터</a>
										<ul class="sitemap-d3">
											<li><a href="http://groupc.dothome.co.kr/html/data_download.html">전처리 데이터 다운로드</a></li>
										</ul>
									</li>
								</ul>
								<ul class="sitemap-d2">
									<li class="has-child"><a href="http://groupc.dothome.co.kr/html/mysql.php">DB조회</a>
										<ul class="sitemap-d3">
											<li><a href="http://groupc.dothome.co.kr/html/howwork.html">DB조회 방법</a></li>
						...
						<ul class="sitemap-d1 s4">
							<li><a href="http://groupc.dothome.co.kr/index.html">C조소개</a>
							</li>
						</ul>
					</div>
...
<div id="container">
	<div id="sidebar" style="height: 270px;"> 
		...
		<div class="lnb-top">
			...
			<ul id="leftMenuUi" class="lnbs">
				<li class="has-child">							
					<a href="http://groupc.dothome.co.kr/html/data_download.html"><span>전처리 데이터</span></a>
				...
				<li class="has-child">							
					<a href="http://groupc.dothome.co.kr/mysql.php"><span>DB 조회</span></a>
						<ul class="lnb_list1">
							<li><a href="http://groupc.dothome.co.kr/html/howwork.html">DB 조회 방법</a></li>								
	...
	<div id="content2" class="sub2" align="center" style="margin-top: 60px; border: 2px solid black;">
		
	<div class="content-head" style="margin-left: 20px;">
...
">
					...
					⊙검색조건: &nbsp;&nbsp;
						...
						<span>
							<select name="Year" class="select year" id="year">
								...
								<option value="201505">201502</option>
   ...
   <br>	
   <br> 
   <img src="./index_files/image/temperature.png"> 표층수온 : &nbsp;
   <input type="text" id="amount" readonly="" style="border:0;color:#f6931f;font-weight:bold;padding-bottom: 10px;" name="slide-value">  
   <input type="hidden" id="min" value="-10" name="min">
   <input type="hidden" id="max" value="32" name="max">
   <div id="slider-range" style="width: 182px;height: 22px;margin-top: 20px;margin-left: 20px;" class="ui-slider ui-corner-all ui-slider-horizontal ui-widget ui-widget-content">
   <div class="ui-slider-range" style="left: 0%; width: 100%;"></div>
   <span tabindex="0" class="ui-slider-handle ui-corner-all ui-state-default" style="left: 0%;"></span>
   <span tabindex="0" class="ui-slider-handle ui-corner-all ui-state-default" style="left: 100%;"></span>
   </div>
   <br>
     <input type="submit" name="submit" value="검색하기" class="button_search" style="
    height: 60px;
    padding-top: 5px;
    padding-bottom: 5px;
    padding-left: 15px;
...
"><br><br> <!--입력한 검색조건 php로 전달하기-->
	...
	<br>
    	<button type="button" onclick="location.href='http://groupc.dothome.co.kr/final.csv'" class="btncsv" style="float: right; margin-top: 10px;"><i class="fa fa-download"></i>CSV 원본 다운로드</button>
		<button type="button" class="btncsv" id="csvDownloadButton" style="float: right;margin-top: 10px;margin-right: 5px;;"><i class="fa fa-download"></i>보이는 Data 다운로드</button>
    <div id="content3" class="sub2" style="margin-top: 80px;width: 1000px;margin-left: 0px;padding-left: 40px;margin-bottom: 100px;">
    <?php
				$db_host = "localhost"; 
				$db_user = "groupc"; 
				$db_passwd = "Cgroup12!";
