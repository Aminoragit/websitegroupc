(function(d, h, i, b) {
	var e = '<div class="msgboxOverlay"><div class="alert-box msgwrapper"><div class="information"><div class="msgcontainer"><div class="msgheader"><a href="javascript:void(0);" class="msgclose">Close</a><span>Message Box Title</span></div><div class="msg">Text</div><div class="msgfooter"></div></div></div></div></div>';
	var g;
	...
	k.prototype.createMessageBox = function() {
		...
		if (this.settings.height) {
			l.find(".msg").height(this.settings.height);
		}
