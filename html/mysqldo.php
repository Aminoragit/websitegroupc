				...
				<div class="mgnbs-div">
					<div class="mgnbs-div2">
						<dl>
							...
							<dd>
								<ul>
									<li class="sub3_2_1"><a href="https://aminoragit.github.io/websitegroupc/html/mysqldo.php">DB 조회 방법</a></li>
									<li class="sub3_2_2"><a href="http://groupc.dothome.co.kr/mysqldo.php">DB 조회 페이지</a></li>
								</ul>									
							</dd>		
						</dl>	
				...
				<div class="mgnbs-div3" style="display: block;width: 1080px;">
					<div class="section-sitemap">
						...
						<ul class="sitemap-d1 s3">
							<li><a href="http://groupc.dothome.co.kr/mysqldo.php">MYSQL</a>
								<ul class="sitemap-d2">
								...
								<ul class="sitemap-d2">
									<li class="has-child"><a href="http://groupc.dothome.co.kr/mysqldo.php">DB조회</a>
										<ul class="sitemap-d3">
											<li><a href="https://aminoragit.github.io/websitegroupc/html/mysqldo.php">DB조회 방법</a></li>
											<li><a href="http://groupc.dothome.co.kr/mysqldo.php" >DB조회 페이지</a></li>
										</ul>
									</li>
								</ul>
							</li>
...
<div id="container">
	<div id="sidebar" style="height: 270px;"> 
		...
		<div class="lnb-top">
			...
			<ul id="leftMenuUi" class="lnbs">
				...
				<li class="has-child">							
					<a href="http://groupc.dothome.co.kr/mysqldo.php"><span>DB 조회</span></a>
						<ul class="lnb_list1">
							<li><a href="https://aminoragit.github.io/websitegroupc/html/mysqldo.php">DB 조회 방법</a></li>								
							<li><a href="http://groupc.dothome.co.kr/mysqldo.php">DB 조회페이지</a></li>	
						</ul>
				</li>
			</ul>
	...
	<form method="POST" action="mysqldo.php">
    년월 : <select name="taskOption">
    ...
    생태구역 : <select name="area">
      ...
      표층수온 : <input type="text" id="amount" readonly style="border:0; color:#f6931f; font-weight:bold;" name="slide-value" />
      ...
      <input type="hidden" id="max" value="32"name='max' />
        ...
        <input type="submit" name="submit" /><br><br> <!--입력한 검색조건 php로 전달하기-->
  </form>
